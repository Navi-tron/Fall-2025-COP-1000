# Furniture.py - This program calculates profits and 
# sales prices for a furniture company.

itemName = "TV Stand"
retailPrice = 325.00
wholesalePrice = 200.00

# Write your assignment statements here for profit, 
# salePrice, and saleProfit
profit = float(retailPrice - wholesalePrice)
